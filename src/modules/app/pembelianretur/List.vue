...
export default {
   ...
   Pembfields: ["tanggal:date","code",
    "Supplier.name",">qty:decimal", ">qty_pending:decimal", ">qty_returned:decimal",">total:decimal",
    "status:badge","status_payment:badge"],
    fields: ["tanggal:date","PembelianId","code",">qty_returned:int","status:badge"],
    ...
    methods: {
        ...
        async saveAddItem() {
            ...
            try {
                //Save
                var result = await this.$api.post("pembelian-retur", this.model, true);
