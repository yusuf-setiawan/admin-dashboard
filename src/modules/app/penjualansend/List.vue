<template>
    <div class="page-pengirimanbarang">
...
export default {
    ...
    "Customer.name",">qty:decimal", ">qty_pending:decimal", ">qty_sent:decimal",">total:decimal",
    "status:badge","status_payment:badge"],
    fields: ["tanggal:date","PenjualanId","code",">qty_sent:decimal","status:badge"],
    ...
    methods: {
        ...
        async saveAddItem() {
            ...
            try {
                //Save
                var result = await this.$api.post("penjualan-send", this.model, true);
